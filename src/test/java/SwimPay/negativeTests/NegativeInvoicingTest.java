...
//		invoicingPage.SelectNextMonth("July 2024");
	    ...
	    invoicingPage.ClickOnButtons(13);
	    Assert.assertTrue(invoicingPage.ClickOnButtons(13)); //Customer btn
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	//Verify if user is able to insert the invalid details in Discount & tax field in Create Invoice Sub-menu 
	@Test(priority=9)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	//Verify if user is able to search by inserting invalid Reference and date details in invoice list submenu
	@Test(priority=10)
	...
	@Test(priority=11)
	public void InsertInvalidDatesInFromAndToField()
	{
		loginPage LoginPage=new loginPage(driver);
		LoginPage.userEmail(email1);
		LoginPage.loginEmailSubmit();
		...
		invoicingPage.EnterDate(1, "01 Feb 2024");  //from date
		invoicingPage.waitcode();
		invoicingPage.EnterDate(0, "24 Jul 2025");   //To date
		invoicingPage.ClickOnSearchBtn();
	}
}
