...
public class payments extends baseClass{
	...
	@Test(priority=2)
	public void payments_payerDataSubmit()
	{
		LoginPage.userEmail(email1);
		LoginPage.loginEmailSubmit();
		LoginPage.userPassword(password);
	...
	@Test(priority=3)
	public void payments_createPaymentsSubmit()
	{
		LoginPage.userEmail(email1);
		LoginPage.loginEmailSubmit();
		LoginPage.userPassword(password);
	...
	@Test(priority=4)
	public void payments_bySelectPaymentProcessAs_supplierBill()
	{
	...
	//Verify payment by selecting payment purpose as Transportation fees for goods option
	@Test(priority=5)
	public void payments_bySelectPaymentProcessAs_transportationGoodsOption()
	{
	...
	@Test(priority=6)
	public void payments_bySelectPaymentProcessAs_refundsOption()
	{
	...
	//Verify click on add recipient/payee option when recipient list is not present for selected currency option
	@Test(priority=7)
	...
	//Verify add recipient/payee details when no data displays for recipient/payee option according to selected currency and perform payment process
	@Test(priority=8)
	public void payments_addRecipientPayeeData_whenRecipient_payeeOption_notActiveForSelectedCurrency() throws InterruptedException
	{
	...
	//Verify add recipient/payee details with account type as Individual option selection when no data displays for recipient/payee option according to selected currency and perform payment process
	@Test(priority=9)
	...
	//Verify add recipient/payee details with selecting "yes" for "SWiM PAY Wallet as Recipient/Payee" when no data displays for recipient/payee option according to selected currency and perform payment process
	@Test(priority=10)
	public void payments_addRecipientPayeeData_whenRecipient_payeeOption_notActiveForSelectedCurrency_withSelectingSwimPayWallet_asYes() throws InterruptedException
	{
		LoginPage.userEmail(email1);
		LoginPage.loginEmailSubmit();
		LoginPage.userPassword(password);
	...
	//Verify clicking on Back button from Review details steps
		...
		//Verify click on  back to recipient/Payee list button from recipient/payee details page
		@Test(priority=12)
		...
		//Verify click on  back to recipient/Payee list button from recipient/payee details page when data provided in fields
		@Test(priority=13)
