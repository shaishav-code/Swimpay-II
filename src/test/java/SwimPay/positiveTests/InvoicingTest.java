...
public class InvoicingTest extends baseClass {
	...
	// Verify if user is able to click on Intruction Sub-menu and can scroll till
	...
	// Verify if user is able to upload the valid document in the Instruction
	// Sub-menu
	@Test(priority = 6)
	...
	// Verify if user is able to click on update logo button and can get the Success
	...
	// Verify if user is able to click on update logo button and can proceed further
	// by click on the Next button
	@Test(priority = 8)
	...
	// Verify if user is able to click on Create Invoice Sub-menu and can scroll
	...
	// Verify if user is able to enter the purchase order and can select the due
	// date in Create Invoice Sub-menu
	@Test(priority = 10)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	// Verify if user is able to insert the External Company details in Create
	// Invoice Sub-menu
	@Test(priority = 11)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	// Verify if user is able to add the items and delete the item fields in Create
	// Invoice Sub-menu
	@Test(priority = 12)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	// Verify if user is able to add the items and insert the Item description Cost
	// & Quantity details in Create Invoice Sub-menu
	@Test(priority = 13)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	// Verify if user is able to insert the notes, Discount & tax details in Create
	// Invoice Sub-menu
	@Test(priority = 14)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	// Verify if user is able to insert the entire details in Create Invoice submenu
	// and can go to next page i.e.invoice List
	@Test(priority = 15)
...
//		invoicingPage.SelectNextMonth("July 2024");
		...
		invoicingPage.waitcode();
		// Assert.assertEquals(invoicingPage.GetCurrentURL(),
		// "https://demo.swimpay.com/invoicing");
	}

	// verfiy the user create an invoice for swimpay customer
	@Test(priority = 16)
...
//		invoicingPage.SelectNextMonth("July 2024");
	...
	// Verify if user is able to enter all the required details and click on Search
	// button in invoice list submenu
	@Test(priority = 19)
	...
	// Verify if user is able to reset filters and click on the refresh icon in
	// invoice list submenu
	@Test(priority = 20)
	...
	public void ClickOnPreviewButton() {
		...
		invoicingPage.ClickOnSearchBtn();
		invoicingPage.waitcode();
		invoicingPage.ClickOnPreviewButton("INV000181");
		invoicingPage.waitcode();
	...
	public void ClickOnEditButton() {
		...
		invoicingPage.ClickOnSearchBtn();
		invoicingPage.waitcode();
		invoicingPage.ClickOnEditButton("INV000181"); // cross arrow of edit button
		invoicingPage.waitcode();
	}
	...
	public void EditInvoiceDetails() {
		...
		InvoicingPage invoicingPage = LoginPage.InvoicingOption();
		invoicingPage.ClickOnInvoiceListPage();
		invoicingPage.ClickOnEditButton("INV000180");
		invoicingPage.waitcode();
