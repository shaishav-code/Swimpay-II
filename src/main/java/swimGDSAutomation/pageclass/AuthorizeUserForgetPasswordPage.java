...
public class AuthorizeUserForgetPasswordPage extends AbstractComponentsMethods{

	WebDriver driver;
	
	public AuthorizeUserForgetPasswordPage(WebDriver driver)
	{
		super(driver);
		this.driver= driver;
	...
	public void Invalidanswer()
	{
	   ...
	   //Verify if user is able to get the reset password link on mentioned mail 
		public boolean Verify_resetmail()
		{
			...
			loginid.sendKeys("test30@yopmail.com");
		...
		{			
			newpassword.sendKeys("September@86");
			confirmpassword.sendKeys("September@86");
		}
