...
//Find the Account id perform action click
	...
	public void Click_Account_Id(String Accountnum) {
		Account_Id.click();
		...
		try {
			...
			// Account_Id.sendKeys("DEMO1 UK (SP000120)");
		}
	}
...
// find Bank Account type option and perform required action
	...
	public void bankAccountTypeCorporateOption() {
		// System.out.println("Button Selection is "+
		// BankAccountType_CorporateOpt.isEnabled());
	...
	public void payclick(String name) {
		...
		for (int i = 1; i < allname.size(); i++) {
			...
			if (nametxt.equals(name)) {
				...
				driver.findElement(By.xpath("//div[@class='recipientPayees-container']/div[3]/table/tbody/tr[" + (i + 1)
						+ "]/td[5]/div/button")).click();
				break;
			}
		}
...
//Find the click the Pay field Edit button perform action click
	...
	public void Editclick(String Name) {
		for (int i = 1; i < allname.size(); i++) {
			...
			scrollActionBulk(EditBtn.get(i));
			{
				String nametxt = EditBtn.get(i).getText();
				if (nametxt.equals(Name)) {
					System.out.println(Name);
					driver.findElement(By.xpath(
							"//div[@class='recipientPayees-container']/div[3]/table/tbody/tr/td[5]/div/span[1]/button"))
							.click();
					break;
	...
	public void Deleteclick(String Delete) {
		...
		for (int i = 1; i < DeleteBtn.size(); i++) {
			...
			if (delete.equals(Delete)) {
				...
				driver.findElement(By.xpath(
						"//div[@class='recipientPayees-container']/div[3]/table/tbody/tr/td[5]/div/span[2]/button"))
						.click();
			}
		}
	}
	...
	public void SWiMPAYWalletspayclick(String SWiMPAYWalletname) {
		...
		for (int i = 1; i < SWiMPAYWalletsallname.size(); i++) {
			...
			if (nametxt.equals(SWiMPAYWalletname)) {
				...
				driver.findElement(
						By.xpath("//div[@class='recipientPayees-container']/div[3]/table/tbody/tr/td[4]/div/button"))
						.click();
				break;
			}
		}
	...
	public void SWiMPAYWalletsDeleteBtn(String Viraj2) {
		for (WebElement name : SWiMPAYWalletsDeleteBtn) {
			...
			if (nametxt.equals(Viraj2)) {
				name.findElement(
						By.xpath("//div[@class='recipientPayees-container']/div[3]/table/tbody/tr/td[4]/div/span"))
						.click();
			}
		}
	}
